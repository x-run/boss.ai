import type { ActivityItem } from "../../lib/workerProfile";
    ...
    <div className="bg-white/[0.025] border border-white/[0.06] rounded-2xl p-6">
      ...
      <div className="space-y-1">
        {activities.map((a, i) => (
          ...
          >
            <div className="text-neutral-600 group-hover:text-emerald-400 transition-colors shrink-0">
              <ActivityIcon icon={a.icon} />
            </div>
            <span className="flex-1 text-[12px] text-neutral-400 group-hover:text-neutral-200 transition-colors truncate">
              {a.label}
            </span>
            <span className="text-[11px] font-bold text-emerald-400/80 tabular-nums shrink-0">
              +{a.xpDelta} XP
            </span>
            <span className="text-[10px] text-neutral-700 shrink-0 w-16 text-right">
              {a.timeAgo}
            </span>
          </div>
        ))}
